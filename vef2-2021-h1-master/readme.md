...
Fyrsta hópverkefnið í vefforritun 2 á vorönn 2021. <br/>
Í hópinum eru;
...
#### verkefnið er sett upp á heruko; https://vef2-2021-h1-bekk.herokuapp.com/
## Keyrsla á verkefninu
Efirfarandi skref þarf að framkvæma svo hægt sé að keyra verkefnið á eigin tölvu. 
...
2. Búa þarf til aðgang á Cloudinary og PostgresSql ef enginn aðgangur er nú þegar til. 
   ATH - við reyndum að setja upp Cloudinary á Heroku en vorum beðnar um kortaupplýsingar, svo við slepptum því.
3. Búa þarf til .env skrá og skilgreina eftirfarandi breytur í henni: 
 ```
    1. PORT=3000
...
Aðgangur fyrir admin 
* Notendanafn: admin
* Lykilorð: 1234567890

Aðgangur fyrir notandi 
* Notendanafn: siggastud
* Lykilorð: 123456789s


## Köll í vefþjónustuna
Hér fyrir neðan eru dæmi um köll í vefþjónustunni
1. Birtum blaðsíðu 2 af sjónvarpasþættunum 
 ``` `GET` á `/tv/?offset=10&limit=10` mun skila blaðsíðu tvö af sjónvarpsþáttum sem eru til ```
 2. skilum upplýsingum um 1 þátt
 
```
`GET` á `/tv/3/season/2/episode/3` sem mun skila 3 þætti í seríu 2 ad The good doctor. Þeir þættir eru með id=3
``` 
